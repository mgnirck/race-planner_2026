        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap mb-1">
              ...
              <button onClick={() => onEdit(hero)} title={t('plan.edit')} className="ml-1 text-gray-300 hover:text-gray-500 transition-colors">
              ...
              <button onClick={() => onDelete(hero.id)} title={t('plan.delete')} className="text-gray-300 hover:text-red-400 transition-colors">
  ...
  return (
    <div className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0">
      ...
      <div className="flex items-center gap-1.5 flex-shrink-0">
        <button onClick={() => onEdit(plan)} title={t('plan.edit')} className="text-gray-300 hover:text-gray-500 transition-colors p-0.5">
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15.232 5.232l3.536 3.536M9 13l-4 1 1-4 9.293-9.293a1 1 0 011.414 0l2.586 2.586a1 1 0 010 1.414L9 13z"/></svg>
        </button>
        <button onClick={() => onDelete(plan.id)} title={t('plan.delete')} className="text-gray-300 hover:text-red-400 transition-colors p-0.5">
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6M9 7h6m-7 0a1 1 0 01-1-1V5a1 1 0 011-1h6a1 1 0 011 1v1a1 1 0 01-1 1H9z"/></svg>
        </button>
      ...
      <footer className="border-t border-gray-100 mt-8 pb-12">
        <div className="max-w-lg mx-auto px-5 pt-8 space-y-6">
          ...
          <div className="text-center">
            <p className="text-xs text-gray-400 mb-2">{t('footer.findLecka')}</p>
